...
use Ppl\PplRightsManagement\Service\GroupRightsInheritanceManagementService;
...
#[AsController]
class GroupRightsInheritanceManagementController extends AbstractRightsManagementController
{
    public function __construct(
        ...
        private readonly GroupRightsInheritanceManagementService $service
    ) {
    ...
    {
        return 'RightsManagement/GroupRightsInheritanceManagement';
    }
