...
use Ppl\PplRightsManagement\Service\GroupRightsManagementService;
...
#[AsController]
class GroupRightsManagementController extends AbstractRightsManagementController
{
    public function __construct(
        ...
        private readonly GroupRightsManagementService $service
    ) {
    ...
    {
        return 'group-rights-management';
    }

    protected function getTemplateName(): string
    {
        return 'RightsManagement/GroupRightsManagement';
    }
