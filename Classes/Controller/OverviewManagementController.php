...
use Ppl\PplRightsManagement\Service\OverviewManagementService;
...
#[AsController]
class OverviewManagementController extends AbstractRightsManagementController
{
    public function __construct(
        ...
        private readonly OverviewManagementService $service
    ) {
    ...
    {
        return 'RightsManagement/Overview';
    }
