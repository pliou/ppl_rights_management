...
use Ppl\PplRightsManagement\Service\GroupManagementService;
...
#[AsController]
class GroupManagementController extends AbstractRightsManagementController
{
    public function __construct(
        ...
        private readonly GroupManagementService $service
    ) {
