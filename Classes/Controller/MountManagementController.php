...
use Ppl\PplRightsManagement\Service\MountManagementService;
...
#[AsController]
class MountManagementController extends AbstractRightsManagementController
{
    public function __construct(
        ...
        private readonly MountManagementService $service
    ) {
    ...
    {
        return 'RightsManagement/MountManagement';
    }
