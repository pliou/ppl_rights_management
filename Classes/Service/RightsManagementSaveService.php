    ...
    private function assertDataHandlerMapsAllowed(string $scope, array $dataMap, array $commandMap): void
    {
        $allowedFields = match ($scope) {
            ...
            'group-rights-management' => [
                'be_groups' => ['pagetypes_select', 'tables_select', 'tables_modify', 'explicit_allowdeny'],
            ],
            'module-management' => [
                'be_groups' => ['groupMods', 'explicit_allowdeny'],
            ],
            'group-rights-inheritance-management' => [
                'be_groups' => ['subgroup', 'explicit_allowdeny'],
            ],
            'mount-management' => [
                'be_groups' => ['db_mountpoints', 'file_mountpoints', 'explicit_allowdeny'],
            ],
